    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 space-y-6">
            ...
            <div class="text-center space-y-2">
                ...
                <p class="text-slate-600 dark:text-slate-400">Create an account to access the jokes</p>
            </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            autofocus
                            autocomplete="name"
                            class="block w-full pl-10 pr-3 py-3 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors @error('name') border-red-500 dark:border-red-500 @enderror"
            ...
            <div class="text-center pt-4 border-t border-slate-200 dark:border-slate-700">
                <p class="text-sm text-slate-600 dark:text-slate-400">
                    ...
                    <a href="{{ route('login.show') }}" class="font-medium text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300">
                        Sign in
                    </a>
                </p>
            </div>
